/**
* @brief: openvslam_exports.h
* @author: Zhang Cheng
*/

#ifndef OPENVSLAM_EXPORTS_H
#define OPENVSLAM_EXPORTS_H
    ...
    #if defined(OPENVSLAM_DLL_EXPORT)
        #define OPENVSLAM_API __declspec(dllexport)
    #else
        #define OPENVSLAM_API __declspec(dllimport)
    #endif
...
#else
    #define OPENVSLAM_API
#endif



#endif // OPENVSLAM_EXPORTS_H
